<template>
  <div
    class="group relative bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-lg p-4 cursor-pointer transition-all hover:border-[var(--accent-mauve)] hover:shadow-lg hover:shadow-black/20"
  ...
  >
    ...
    <button
      v-if="repoCount > 0"
      class="absolute bottom-3 right-3 text-[var(--text-faint)] hover:text-[var(--accent-teal)] opacity-0 group-hover:opacity-100 transition-all"
