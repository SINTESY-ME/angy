      ...
      <div class="w-[560px] max-h-[80vh] bg-[var(--bg-window)] border border-[var(--border-standard)] rounded-xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          <div>
            ...
            <!-- Existing repos -->
            <div v-for="repo in existingRepos" :key="repo.id" class="bg-[var(--bg-raised)] border border-[var(--border-subtle)] rounded-lg p-3 mb-2">
            ...
            <div v-for="(repo, i) in newRepos" :key="'new-' + i" class="bg-[var(--bg-raised)] border border-[var(--border-subtle)] rounded-lg p-3 mb-2 space-y-2">
