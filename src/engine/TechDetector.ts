...
export interface TechProfile {
  ...
  name: string;
  icon: string;
  markerFiles: string[];       // Files to look for (existence check)
  markerContent?: { file: string; pattern: string }[];  // Optional: grep inside files
  systemPrompt: string;        // Best-practice guidelines to inject
}
